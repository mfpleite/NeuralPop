...
P.A(4).M = [log(.5) -32;  % inhibitory
            -32 -32];
        
P.C(1).M = [log(.1) log(8)]'; % excitatory exogenous input
...
% plot(M2.opt.t(1:M2.opt.Kend),squeeze(M2.GV(1,1,1:M2.opt.Kend)),'m.')
% plot(M3.opt.t(1:M3.opt.Kend),squeeze(M3.GV(1,1,1:M3.opt.Kend)),'g.')
